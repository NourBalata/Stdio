                                        ...
                                        <div class="add-group">
                                            <a href="#" data-bs-toggle="modal"
                                               ...
                                               class=" modal-effect btn btn-primary add-pluss ms-2"><img
                                                    src="{{asset('dashboard/assets/img/icons/plus.svg')}}" alt=""> Add Services</a>
                                        ...
                                        <div class="dropdown dropdown-action">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-end">
                                                <a class="dropdown-item" href="#" data-bs-toggle="modal"
                                                   data-bs-target="#edit_category" data-service_id="{{$info->id}}"
                                                   data-title="{{$info->title}}" data-summary="{{$info->summary}}"
