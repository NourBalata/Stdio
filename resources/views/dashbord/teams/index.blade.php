                                        ...
                                        <div class="dropdown dropdown-action">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-end">
                                                <a class="dropdown-item" href="#" data-bs-toggle="modal"
                                                   data-bs-target="#edit_category" data-team_id="{{$info->id}}"
                                                   data-title="{{$info->title}}" data-slug="{{$info->slug}}"
                                                   data-image="{{$info->image}}"
                                                        class="fa fa-trash-alt m-r-5"></i> Edit</a>
                                                     

                                                <a class="dropdown-item" data-team_id="{{$info->id}}" href="#"
...
<div class="modal custom-modal fade invoices-preview" id="edit_category" role="dialog">
                        ...
                        <div class="col-lg-12">
                            <div class="card invoice-info-card">
                                <div class="card-body pb-0">
                                    <div class="modal-body">
                                        <form action="{{route('teams.update','edit')}}" method="post"
            ...
            <div class="modal-content">
                <div class="modal-body">
                    ...
                    <div class="modal-btn delete-action">
                        <div class="row">
                            <div class="col-6">
                                <form action="{{route('teams.destroy','delete')}}" method="post">
                                    @csrf
                                    @method('DELETE')
                                    <input type="hidden" id="team_id" value="" name="team_id">
 ...
 <div class="modal custom-modal fade invoices-preview" id="add_team" role="dialog">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="add_category">New Team</h5>
                    <button type="button" class="close" data-bs-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true"> &times;</span>
                    </button>
                </div>
